        ...
        <div className="flex-1 bg-white dark:bg-gray-800 rounded-3xl border border-gray-200 dark:border-gray-700 p-8 shadow-sm min-h-[500px]">
          ...
          {activeTab === "general" && (
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4">
              <SectionHeader
                ...
                description="Adjust the visual settings for your local session."
              />
          ...
          {activeTab === "system" && (
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4">
              <SectionHeader
                title="Operations"
                description="Manage data polling and reporting defaults."
              />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <SettingsSelect
                  ...
                  onChange={(v) =>
                    setSettings({ ...settings, refreshInterval: v })
                  }
                ...
                <SettingsSelect
                  ...
                  onChange={(v) =>
                    setSettings({ ...settings, reportFormat: v })
                  }
                ...
                <div className="p-6 border border-red-100 dark:border-red-900/20 bg-red-50/50 dark:bg-red-900/10 rounded-2xl flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      This will reset all your persisted dashboard settings.
                    </p>
                  </div>
          ...
          {activeTab === "security" && (
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4">
              <SectionHeader
                ...
                description="View and manage user authority levels."
              />
